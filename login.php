...
<head>
    ...
    <title>Login E-Learning SMA Taman Madya Jetis Yogyakarta</title>
...
<body>
    ...
    #foto{
        ...
        padding-bottom: 30px;
                ...
                <a class="navbar-brand" href="./"> 
                    <img id="foto" src="style/assets/img/DD.png" style="height: 100px" style="width: auto"/>
                </a>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2019 e-Learning SMA Taman Madya Jetis Yogyakarta | By : Rivaldi Samad
                </div>
