...
<div class="row">
    ...
    <div class="col-md-12"> 
        <div class="panel panel-default">
            <div class="panel-heading"><a href="?page=daftarpengajar&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a> <a href="./laporan/cetak.php?data=pengajar" target="_blank" class="btn btn-default btn-sm">Cetak Data Pengajar</a></div>
                        ...
                        if(mysqli_num_rows($sql_pengajar) > 0) {
	                        ...
	                        ?>
	                            <tr>
	                                ...
	                                <td><?php echo $data_pengajar['email']; ?></td>
	                                <td><?php echo $data_pengajar['alamat']; ?></td>
	                                <td><?php echo ucfirst($data_pengajar['status']); ?></td>
	                                <td align="center" width="170px">
	                                    <a href="?page=daftarpengajar&action=edit&id=<?php echo $data_pengajar['id_pengajar']; ?>" class="badge" style="background-color:#f60;">Edit</a>
	                                    <a onclick="return confirm('Yakin akan menghapus data?');" href="?page=daftarpengajar&action=hapus&id=<?php echo $data_pengajar['id_pengajar']; ?>" class="badge" style="background-color:#f00;">Hapus</a>
	                                    <a href="?page=daftarpengajar&action=detail&id=<?php echo $data_pengajar['id_pengajar']; ?>" class="badge">Detail</a>
	                                </td>
	                            </tr>
	                        <?php
		                    }
    ...
    <?php
		...
		<div class="col-md-12">
	        <div class="panel panel-default">
	            <div class="panel-heading">Detail Data Pengajar &nbsp; <a href="?page=daftarpengajar" class="btn btn-warning btn-sm">Kembali</a></div>
	            <div class="panel-body">
	            	<div class="table-responsive">
                        <table width="100%">
                        	<tr>
		...
		<div class="col-md-6">
	        <div class="panel panel-default">
	            <div class="panel-heading">Tambah Data Pengajar &nbsp; <a href="?page=daftarpengajar" class="btn btn-warning btn-sm">Kembali</a></div>
	            <div class="panel-body">
					<form method="post" action="?page=daftarpengajar&action=prosestambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control" id="input" required  placeholder="password"/>
							<label class="informasi">Password anda: <span class="status lemah">lemah</label>
                        </div>
                        <div class="form-group">
		...
		if($nama_gambar != '') {
			if(move_uploaded_file($sumber, $target.$nama_gambar)) {
				...
				echo '<script>window.location="?page=daftarpengajar";</script>';
			} else {
				echo '<script>alert("Gagal menambah data pengajar, foto gagal diupload, coba lagi!"); window.location="?page=daftarpengajar";</script>';
			}
		} else {
		...
		<div class="col-md-6">
	        <div class="panel panel-default">
	            <div class="panel-heading">Edit Data Pengajar &nbsp; <a href="?page=daftarpengajar" class="btn btn-warning btn-sm">Kembali</a></div>
	            <div class="panel-body">
					<form method="post" action="?page=daftarpengajar&action=prosesedit&id=<?php echo $data['id_pengajar']; ?>" enctype="multipart/form-data">
      					<div class="form-group">
                            <label>NIP *</label>
		...
		if($nama_gambar == '') {
			...
			if(move_uploaded_file($sumber, $target.$nama_gambar)) {
				...
				echo '<script>alert("Gagal mengedit data pengajar, foto gagal diupload, coba lagi!"); window.location="?page=daftarpengajar";</script>';
			}
		}
