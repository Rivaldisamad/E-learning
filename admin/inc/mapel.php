...
if(@$_SESSION[admin]) {
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Mata Pelajaran yang Anda Ajar </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                            ...
                            <tbody>
                            <?php
                            $sql_mapel_ajar = mysqli_query($db, "SELECT * FROM tb_mapel_ajar JOIN tb_mapel ON 
                            tb_mapel_ajar.id_mapel = tb_mapel.id JOIN tb_kelas ON 
                            tb_mapel_ajar.id_kelas = tb_kelas.id_kelas WHERE 
                            tb_mapel_ajar.id_pengajar = '$_SESSION[pengajar]'") or die ($db->error);
